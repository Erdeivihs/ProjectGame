                            ...
                            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
                                ...
                                <div class="hexagon-menu clear">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a  class="hex-content" href="#/indie">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                                <i class="fa-solid fa-person"></i>
                                                </span>
                                                <span class="title">Indie</span>
                                            </span>
                                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>
                                    </div>
                                    <div class="hexagon-item">
                                        ...
                                        <a  class="hex-content" href="#/shooter">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                                <i class="fa-solid fa-gun"></i>
                                                </span>
                                                <span class="title">Shooter</span>
                                            </span>
                                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>    
                                    </div>
                                    <div class="hexagon-item">
                                        ...
                                        <a  class="hex-content" href="#/plataformeo">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                                <i class="fa-brands fa-fly"></i>
                                                </span>
                                                <span class="title">Plataformeo</span>
                                            </span>
                                            <svg viewBox="0 0 173.20508075688772 200" height="200" width="174" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M86.60254037844386 0L173.20508075688772 50L173.20508075688772 150L86.60254037844386 200L0 150L0 50Z" fill="#1e2530"></path></svg>
                                        </a>
                                    </div>
                                    <div class="hexagon-item">
                                        ...
                                        <a  class="hex-content" href="#/deportes">
                                            <span class="hex-content-inner">
                                                <span class="icon">
                                    ...
                                    <div class="hexagon-item">
                                        ...
                                        <a  class="hex-content" href="#/carreras">
                                            <span class="hex-content-inner">
                                                <span class="icon">
